...
<!--  apple-touch-icon -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url();?>assets/img/logo/logo.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url();?>assets/img/logo/logo.png">
...
<!-- animate CSS -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/animate.min.css" media="all" />

<!-- FontAwesome CSS -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/fonts/font-awesome/css/font-awesome.min.css" media="all" />

<!-- Owl Carousel -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/owl.carousel.min.css" media="all" />

<!-- Bootsnav Menu -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/bootsnav.css" media="all" />

<!-- Bootstrap -->
<link rel="stylesheet"  href="<?php echo base_url();?>assets/plugin/bootstrap/css/bootstrap.min.css" media="all" />

<!-- Style CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/style-red.css" media="all" />
