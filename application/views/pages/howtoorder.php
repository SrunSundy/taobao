...
<html lang="en">
	...
	<body>
		...
		<!-- ::::::::::::::::::::: Accordian Section:::::::::::::::::::::::::: -->
		<section class="accordian-section section-padding" style="padding-top: 60px;">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p class="favorite-font-amaranth" style="font-size: 32px;  font-weight: 400;color: black">How to Order</p>
					</div>
				</div>
			</div>
